//Cody Stoner
// Run this program to figure out the bend and resistance of the bend from the bananas.
// I only use this for getting the resting straight position of the banana.
